    <section class="schedule">
      ...
      <div class="shop-switch">
        <a href="/schedule/all" class="item"><span class="text<?php if($shop_id == 'all') echo ' yellow'; ?>">全店舗</span></a>
        <?php foreach($groupShopArray AS $key => $value){ ?>
            <a href="/schedule/<?php echo $key; ?>" class="item"><span class="text<?php if($shop_id == $key) echo ' yellow"'; ?>"><?php echo $value['name']; ?></span></a>
        <?php } ?>
      </div>
      ...
      <div class="date-selector swiper-container">
		...
		<?php foreach($workDateFrontPrintArray AS $key => $value){ ?>
		    <button class="swiper-slide item<?php if($day == $workDateArray[$key]) echo ' swiper-slide-thumb-active'; ?>"><a href="/schedule/<?php if(!empty($shop_id)) echo $shop_id . '/'; ?><?php echo $workDateArray[$key]; ?>/<?php echo $printChk; ?>" class="schedule-link"><?php echo $value; ?></a></button>
		<?php } ?>
        </div>
      </div>
