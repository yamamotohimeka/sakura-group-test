        ...
        <li class="top-stories-link">
          ...
          <?php if (!empty($value['Girl']['Image']['image'][0][1]['image_url'])) { ?>
            <div class="top-stories-icon">
              <img src="<?php echo $value['Girl']['Image']['image'][0][1]['image_url']; ?>" class="top-stories-iconimage">
            </div>
          <?php } ?>
        ...
        <?php foreach ($printArray['Linebots'] as $key => $value) { ?>
          <div class="swiper-slide">
            <header class="top-stories-info">
              <?php if (!empty($value['Girl']['Image']['image'][0][1]['image_url'])) { ?>
                <div class="icon"><a href="<?php echo $value['Girl']['Girl']['profile_url']; ?>"><img src="<?php echo $value['Girl']['Image']['image'][0][1]['image_url']; ?>"></a></div>
              <?php } ?>
              <h3 class="name"><a href="<?php echo $value['Girl']['Girl']['profile_url']; ?>"><?php echo $value['Girl']['Girl']['name']; ?></a><span class="shop"><?php echo $value['Girl']['Girl']['shop_name']; ?></span></h3>
              <div class="top-stories-attendance">
                <span class="top-stories-attendance-status"><?php echo $value['Girl']['ScheduleStatus']['status']; ?></span>
                <?php if (!empty($value['Girl']['ScheduleStatus']['time'])) { ?><time class="top-stories-attendance-time"><?php echo $value['Girl']['ScheduleStatus']['time']; ?></time><?php } ?>
              </div>
              <a href="<?php echo $value['Girl']['Girl']['profile_url']; ?>#personal-story" class="stories-text">
