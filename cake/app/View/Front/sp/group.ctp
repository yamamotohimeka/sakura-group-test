        ...
        <?php foreach ($printArray['SliderGroup'] as $key => $value) { ?>
          <?php if (!empty($value['Image'][0]['image_url'])) { ?>
            <figure class="swiper-slide">
              ...
              <?php if (!empty($value['Slider']['shop_name'])) { ?><figcaption class="top-slider-shopinfo"><?php echo $value['Slider']['shop_name']; ?></figcaption><?php } ?>
            </figure>
          <?php } ?>
        <?php } ?>
      <?php } ?>
...
<h3 class="top_bnr"><a href="/special/" target="_blank"><img src="/assets/special/img/special3/sp/bnr_special.gif"></a></h3>
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide top-attendance-list">
        ...
        <div class="shop-switch">
          ...
          <?php foreach ($groupShopArray as $key => $value) { ?>
            <a href="/schedule/<?php echo $key; ?>" class="item"><span class="text"><?php echo $value['name']; ?></span></a>
          <?php } ?>
        </div>
            ...
            <?php foreach ($printArray['ScheduleToday'] as $key => $value) { ?>
              <li class="girl<?php if ($value['ScheduleStatus']['status'] == '只今出勤中') echo ' attending'; ?>">
                <div class="girl-state state-attendance">
                  ...
                  <?php if (!empty($value['ScheduleStatus']['time'])) { ?><time class="attending-time"><?php echo $value['ScheduleStatus']['time']; ?></time><?php } ?>
                </div>
                <?php if (!empty($value['Image']['image_url'])) { ?>
                  <div class="girl-image-wrap">
                    <img src="<?php echo $value['Image']['image_url']; ?>?<?php echo date('YmdHis'); ?>" class="girl-image" alt="">
                ...
                <div class="girl-meta">
                  ...
                  <ul class="icons">
                    <?php if (!empty($value['Ranking'][0]['priority'])) { ?><li><img src="/assets/sp/img/common/stats-icon-rank<?php echo $value['Ranking'][0]['priority']; ?>.png" alt="" /></li><?php } ?>
                    <?php if (!empty($value['Girl']['newface'])) { ?><li><img src="/assets/sp/img/common/stats-icon-newface.png" alt="" /></li><?php } ?>
                    <?php if (!empty($value['Girl']['amateur'])) { ?><li><img src="/assets/sp/img/common/stats-icon-beginner.png" alt="" /></li><?php } ?>
                    <?php if (!empty($value['Girl']['twitter_id'])) { ?><li><a href="<?php echo $value['Girl']['twitter_id']; ?>" target="_blank"><img src="/assets/sp/img/common/stats-icon-twitter.png" alt="ツイッター"></a></li><?php } ?>
                  </ul>
                  <ul class="features">
      ...
      <div class="swiper-slide top-realtime-list">
        ...
        <div class="shop-switch">
          <span class="item"><span class="text yellow">全店舗</span></span>
          <?php foreach ($groupShopArray as $key => $value) { ?>
            <a href="/realtime/<?php echo $key; ?>" class="item"><span class="text"><?php echo $value['name']; ?></span></a>
          <?php } ?>
        </div>
                  ...
                  <?php foreach ($printArray['RealTime'][$key2] as $key => $value) { ?>
                    <li class="girl<?php if ($value['Girl']['real_state'] != 1 and $value['Girl']['real_state'] < 10) echo ' attending'; ?>">
                      ...
                      <?php if (!empty($value['Image']['image'][0][1]['image_url'])) { ?>
                        <div class="girl-image-wrap">
                          <img src="<?php echo $value['Image']['image'][0][1]['image_url']; ?>?<?php echo date('YmdHis'); ?>" class="girl-image" alt="">
                          <div class="girl-shop"><?php echo $value['Girl']['shop_name']; ?></div>
                        </div>
                      <?php } ?>
                      <div class="girl-meta">
      ...
      <div class="swiper-slide top-newface-list">
        ...
        <div class="shop-switch">
          <span class="item"><span class="text yellow">全店舗</span></span>
          <?php foreach ($groupShopArray as $key => $value) { ?>
            <a href="/newface/<?php echo $key; ?>" class="item"><span class="text"><?php echo $value['name']; ?></span></a>
          <?php } ?>
        </div>
          ...
          <ul class="girl-list">
            ...
            <?php foreach ($printArray['GirlNewface'] as $key => $value) { ?>
              <li class="girl<?php if ($value['ScheduleStatus']['status'] == '只今出勤中') echo ' attending'; ?>">
                ...
                <?php } ?>
                <div class="girl-meta">
                  <?php if (!empty($value['Girl']['started_at'])) { ?><div class="entry-date"><?php $started_at = new DateTime($value['Girl']['started_at']);
      ...
      <div class="swiper-slide top-ranking-list">
        ...
        <div class="shop-switch">
          <!-- span class="item"><span class="text yellow">全店舗</span></span -->
          <?php foreach ($groupShopArray as $key => $value) { ?>
            <a href="/ranking/<?php echo $key; ?>" class="item"><span class="text<?php if ($key == 1) echo ' yellow'; ?>"><?php echo $value['name']; ?></span></a>
          <?php } ?>
        </div>

        <div class="ranking-switch">
          <input type="radio" name="ranking-switch" id="ranking-1" hidden checked><label for="ranking-1" class="ranking-switch-button tab1">総合</label>
          <?php if (!empty($printArray['Ranking'][1][0]['Ranking']['title'])) { ?><input type="radio" name="ranking-switch" id="ranking-2" hidden><label for="ranking-2" class="ranking-switch-button tab2"><?php echo $printArray['Ranking'][1][0]['Ranking']['title']; ?></label><?php } ?>
          <?php if (!empty($printArray['Ranking'][2][0]['Ranking']['title'])) { ?><input type="radio" name="ranking-switch" id="ranking-3" hidden><label for="ranking-3" class="ranking-switch-button tab3"><?php echo $printArray['Ranking'][2][0]['Ranking']['title']; ?></label><?php } ?>
                  ...
                  <?php foreach ($printArray['Ranking'][$key2] as $key => $value) { ?>
                    <li class="girl<?php if ($value['ScheduleStatus']['status'] == '只今出勤中') echo ' attending'; ?>">
                      <div class="girl-ranking-header">
                        <img src="/assets/sp/img/common/stats-icon-rank<?php echo $value['Ranking']['priority']; ?>.png" alt="ランキング<?php echo $value['Ranking']['priority']; ?>位" class="girl-ranking-icon">
                        <p class="girl-ranking-text">
                          <img src="/assets/sp/img/common/ranking-text.png" alt="" class="girl-ranking-text-image"><br>
                          <?php echo $title; ?>
                        </p>
                      </div>
                      ...
                      <?php if (!empty($value['Image'][1]['Image']['image_url'])) { ?>
                        <div class="girl-image-wrap">
                          <img src="<?php echo $value['Image'][1]['Image']['image_url']; ?>?<?php echo date('YmdHis'); ?>" class="girl-image" alt="">
                          <div class="girl-shop"><?php echo $value['Girl']['shop_name']; ?></div>
                        </div>
                      <?php } ?>
                      <div class="girl-meta">
                        ...
                        <span class="sizes">T<?php echo $value['Girl']['height']; ?> B<?php echo $value['Girl']['size_b']; ?>(<?php echo $cupArray[$value['Girl']['size_c']]; ?>) W<?php echo $value['Girl']['size_w']; ?> H<?php echo $value['Girl']['size_h']; ?></span>
                        <ul class="icons">
                          <?php if (!empty($value['Ranking']['priority'])) { ?><li><img src="/assets/sp/img/common/stats-icon-rank<?php echo $value['Ranking']['priority']; ?>.png" alt="" /></li><?php } ?>
                          <?php if (!empty($value['Girl']['newface'])) { ?><li><img src="/assets/sp/img/common/stats-icon-newface.png" alt="" /></li><?php } ?>
                          <?php if (!empty($value['Girl']['amateur'])) { ?><li><img src="/assets/sp/img/common/stats-icon-beginner.png" alt="" /></li><?php } ?>
                          <?php if (!empty($value['Girl']['twitter_id'])) { ?><li><a href="<?php echo $value['Girl']['twitter_id']; ?>" target="_blank"><img src="/assets/sp/img/common/stats-icon-twitter.png" alt="ツイッター"></a></li><?php } ?>
                        </ul>
