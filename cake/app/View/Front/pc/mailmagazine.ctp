	...
	<div class="mm_wrap">
		<div class="mm_col">
			...
			<p>登録は簡単！下のボタンを押して、空メールを配信するだけです！！<br>
				...
				メールが受信されない場合があります。</p>
			<div class="submit">
				<input type="submit" onclick="location.href='mailto:<?php echo ACMAILER_REG; ?>'" value="メールマガジンに登録する">
			</div>
		...
		<div class="mm_col">
			...
			<div class="content-box" id="p1">
				<div class="submit">
					<input type="submit" onclick="location.href='mailto:<?php echo ACMAILER_DEL; ?>'" value="メールマガジンを解除する">
				</div>
				<?php foreach ($groupShopArray as $key => $value) { ?>
					<div class="submit">
