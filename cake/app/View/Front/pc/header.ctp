	<aside>
		<ul class="side_bnr">
			<li>
				<a href="https://esthetique-osaka.com/top/" target="_blank"><img src="/assets/img/common/bnr_tique.jpg" alt="エステ・ティーク" /></a>
			</li>
			<li>
					...
					<nav>
						<ul class="flex">
							<?php foreach ($groupShopArray as $key => $value) { ?>
								<li><a href="<?php echo $value['url']; ?>top/">clubさくら<?php echo $value['name']; ?></a></li>
							<?php } ?>
							<li><a href="https://esthetique-osaka.com/top/" target="_blank">エステ・ティーク</a></li>
						</ul>
					</nav>
				</div>
